...
class Trainer(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if opt.fix_backbone:
            ...
            print("Your orign_CLIP_model is not fixed. Are you sure you want to proceed? If this is a mistake, enable the --fix_backbone command during training and rerun")
            import time 
            time.sleep(3)
